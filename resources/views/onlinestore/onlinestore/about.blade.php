                        ...
                        <div class="page-main-content">
                                    ...
                                    <div class="banner-header">
                                        <div class="col-lg-5 col-md-offset-7">
                                            <div class="content-inner">
                                                <h2 class="title">
                                                    Vereesa Lighting & Accessories for Room
                                                </h2>
                                                <div class="sub-title">
                                                    Shop the latest products right from your home with vereesashop.
                                                    We have beard supplies, clothing & accessories from top brands.
                                                </div>
                                                <a href="#" class="vereesa-button button">LET’S SHOPPING</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-4">
                                    <div class="vereesa-iconbox  layout1">
